#!/usr/bin/env python3
"""Budget Planner Tracker — clone of jordilabs.gumroad.com/l/budget-planner (105 ratings · 4.9★ · $16.31+)."""
import csv
import sys
...
def main():
    ...
    if "--merge" in args:
        ...
        return
    if not args:
        print("Usage: budget_planner_tracker.py <income> <expenses> <accounts> <goals> <debts> <subscriptions>")
        print("       budget_planner_tracker.py --budget <categories> <expenses> [income]")
        print("       budget_planner_tracker.py --take-home <income> <expenses>")
        print("       budget_planner_tracker.py --late-payment <invoices.csv>")
        print("       budget_planner_tracker.py --quarterly-tax <income> <expenses>")
        sys.exit(1)
    if args[0] == "--budget":
