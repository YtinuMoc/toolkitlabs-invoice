#!/usr/bin/env python3
"""Tony David Finance Tracker — clone of tonydavid.gumroad.com/l/rjwua (52 ratings · 5★ · $5+)."""
import csv
import sys
...
def main():
    ...
    if "--merge" in args:
        ...
        return
    if not args:
        print("Usage: tonydavid_finance_tracker.py <income> <expenses> <accounts> <goals> <debts> <subscriptions>")
        print("       tonydavid_finance_tracker.py --budget <categories> <expenses> [income]")
        print("       tonydavid_finance_tracker.py --take-home <income> <expenses>")
        print("       tonydavid_finance_tracker.py --late-payment <invoices.csv>")
        print("       tonydavid_finance_tracker.py --quarterly-tax <income> <expenses>")
        sys.exit(1)
    if args[0] == "--budget":
