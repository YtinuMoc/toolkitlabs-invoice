#!/usr/bin/env python3
"""Matthew Finance Tracker — clone of matthewnotion.gumroad.com/l/financetracker (58 sales)."""
import csv
import sys
...
def main():
    ...
    if "--merge" in args:
        ...
        return
    if not args:
        print("Usage: matthew_finance_tracker.py <income> <expenses> <accounts> <goals> <debts> <subscriptions>")
        print("       matthew_finance_tracker.py --take-home <income> <expenses>")
        print("       matthew_finance_tracker.py --late-payment <invoices.csv>")
        print("       matthew_finance_tracker.py --quarterly-tax <income> <expenses>")
        sys.exit(1)
    if args[0] == "--take-home":
