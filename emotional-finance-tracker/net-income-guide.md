...
Clone of [faisalmq/5797](https://dev.to/faisalmq/freelance-finance-tracker-google-sheets-5797) buyer channel + [BodegaLabs Emotional Finance Tracker (1,253 sales · 39 ratings · 5★)](https://bodegalaabs.gumroad.com/l/emotional-finance-tracker).
...
BodegaLabs' **Emotional Finance Tracker** rolls income, expenses, savings goals, and spending-trigger reflection into one overview — the safe-spend number belongs in the same workbook.

## Free CLI preview

```bash
python3 emotional_finance_tracker.py --net-income income-sample.csv expenses-sample.csv
```
...
- [merge-ledger-guide.md](merge-ledger-guide.md) — goldenalien/206o platform CSV merge (run353)
...
Full bundle: [Emotional Finance Tracker landing](https://ytinumoc.github.io/toolkitlabs-invoice/emotional-finance-tracker/) — CSV templates, dashboard CLI, and all buyer-channel guides.
