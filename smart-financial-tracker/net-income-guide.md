...
Clone of [faisalmq/5797](https://dev.to/faisalmq/freelance-finance-tracker-google-sheets-5797) buyer channel + [hyeukiyo Notion Smart Financial (133 sales · 5 ratings · 5★)](https://hyeukiyo.gumroad.com/l/Fimgntemp).
...
hyeukiyo's **Smart Financial Tracker** rolls income, expenses, budgets, subscriptions, bills, and wishlist into one overview — the safe-spend number belongs in the same workbook.

## Free CLI preview

```bash
python3 smart_financial_tracker.py --net-income income-sample.csv expenses-sample.csv
```
...
Full bundle: [Smart Financial Tracker landing](https://ytinumoc.github.io/toolkitlabs-invoice/smart-financial-tracker/) — CSV templates, dashboard CLI, and all buyer-channel guides.
