...
Clone of [faisalmq/5797](https://dev.to/faisalmq/freelance-finance-tracker-google-sheets-5797) buyer channel + [fayedinua Finance OS Business Finance Tracker ($39+ · 2 ratings · 5★ · 952 seller reviews)](https://fayedinua.gumroad.com/l/business-finance-tracker-notion).
...
fayedinua's **Finance OS Business Finance Tracker** rolls income, expenses, VAT, invoices, cash flow, and client pipeline into one workspace — the safe-spend number belongs in the same workbook.

## Free CLI preview

```bash
python3 business_finance_tracker.py --net-income income-sample.csv expenses-sample.csv
```
...
- [merge-ledger-guide.md](merge-ledger-guide.md) — goldenalien/206o platform CSV merge (run378)
...
Full bundle: [Business Finance Tracker landing](https://ytinumoc.github.io/toolkitlabs-invoice/business-finance-tracker/) — CSV templates, dashboard CLI, and all buyer-channel guides.
