#!/usr/bin/env python3
"""fayedinua Business Finance Tracker — clone of fayedinua.gumroad.com/l/business-finance-tracker-notion ($39+ · 2 ratings · 5★)."""
import csv
import sys
...
def main():
    ...
    if "--merge" in args:
        ...
        return
    if not args:
        print("Usage: yearly_budget_tracker.py <income> <expenses> <accounts> <goals> <debts> <subscriptions>")
        print("       yearly_budget_tracker.py --budget <categories> <expenses> [income]")
        print("       yearly_budget_tracker.py --take-home <income> <expenses>")
        print("       yearly_budget_tracker.py --wishlist <wishlist.csv> <goals.csv>")
        print("       yearly_budget_tracker.py --quarterly-tax <income> <expenses>")
        sys.exit(1)
    if args[0] == "--budget":
