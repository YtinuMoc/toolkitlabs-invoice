#!/usr/bin/env python3
"""Organized Finance Tracker — clone of somethingorganized.gumroad.com/l/fcoej (934 sales)."""
import csv
import sys
...
def main():
    ...
    if "--merge" in args:
        ...
        return
    if not args:
        print("Usage: organized_finance_tracker.py <income> <expenses> <accounts> <goals> <debts> <subscriptions>")
        print("       organized_finance_tracker.py --take-home <income> <expenses>")
        print("       organized_finance_tracker.py --late-payment <invoices.csv>")
        print("       organized_finance_tracker.py --quarterly-tax <income> <expenses>")
        sys.exit(1)
    if args[0] == "--take-home":
