...
Clone of [faisalmq/5797](https://dev.to/faisalmq/freelance-finance-tracker-google-sheets-5797) buyer channel + [PathPages Notion Finance Tracker (31 ratings · 4.4★ · $59)](https://pathpages.gumroad.com/l/notion-finance-tracker).
...
PathPages' **Notion Finance Tracker** rolls income, expenses, subscriptions, budgets, and savings goals into one workspace — the safe-spend number belongs in the same file.

## Free CLI preview

```bash
python3 pathpages_finance_tracker.py --net-income income-sample.csv expenses-sample.csv
```
...
- [merge-ledger-guide.md](merge-ledger-guide.md) — goldenalien/206o platform CSV merge (run398)
- [tax-buffer-guide.md](tax-buffer-guide.md) — faisalmq/4gao deposit-day transfers (run396)
...
Full bundle: [Notion Finance Tracker landing](https://ytinumoc.github.io/toolkitlabs-invoice/pathpages-finance-tracker/) — CSV templates, dashboard CLI, and all buyer-channel guides.
