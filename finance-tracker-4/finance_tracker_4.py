#!/usr/bin/env python3
"""Finance Tracker 4.0 — clone of jnkxstudio.gumroad.com/l/Finance_Tracker_3 (2,995 sales · 4.9★)."""
import csv
import sys
...
def main():
    ...
    if "--merge" in args:
        ...
        return
    if not args:
        print("Usage: finance_tracker_4.py <income> <expenses> <accounts> <goals> <debts> <subscriptions>")
        print("       finance_tracker_4.py --late-payment <invoices.csv>")
        print("       finance_tracker_4.py --quarterly-tax <income> <expenses>")
        sys.exit(1)
    if args[0] == "--late-payment":
