#!/usr/bin/env python3
"""Finance OS Dashboard — clone of chrisnotion.gumroad.com/l/fcufra (30,427 sales · 506 ratings · 4.9★)."""
import csv
import sys
...
def main():
    ...
    if "--merge" in args:
        ...
        return
    if not args:
        print("Usage: finance_os_dashboard.py <income> <expenses> <accounts> <goals> <debts> <subscriptions>")
        print("       finance_os_dashboard.py --take-home <income> <expenses>")
        print("       finance_os_dashboard.py --late-payment <invoices.csv>")
        print("       finance_os_dashboard.py --quarterly-tax <income> <expenses>")
        sys.exit(1)
    if args[0] == "--take-home":
