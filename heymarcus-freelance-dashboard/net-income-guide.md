...
Clone of [faisalmq/5797](https://dev.to/faisalmq/freelance-finance-tracker-google-sheets-5797) buyer channel + [heymarcus All-in-One Freelance Dashboard (257 sales · 11 ratings · 4.9★)](https://heymarcus.gumroad.com/l/bpqsi).
...
heymarcus's **Finance Tracker** rolls account balances, income, expenses, budgets, subscriptions, and goals into one overview — the safe-spend number belongs in the same workbook.

## Free CLI preview

```bash
python3 heymarcus_freelance_dashboard.py --net-income income-sample.csv expenses-sample.csv
```
...
- [merge-ledger-guide.md](merge-ledger-guide.md) — goldenalien/206o platform CSV merge (run368)
...
Full bundle: [Finance Tracker landing](https://ytinumoc.github.io/toolkitlabs-invoice/heymarcus-freelance-dashboard/) — CSV templates, dashboard CLI, and all buyer-channel guides.
