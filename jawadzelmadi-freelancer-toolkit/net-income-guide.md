...
Clone of [faisalmq/5797](https://dev.to/faisalmq/freelance-finance-tracker-google-sheets-5797) buyer channel + [jawadzelmadi Ultimate Freelancer Toolkit (39 sales · 5 ratings · 5.0★ · $9+)](https://jawadzelmadi.gumroad.com/l/FreelancerToolkit).
...
jawadzelmadi's **Ultimate Freelancer Toolkit** rolls clients, projects, time tracking, invoicing, and income/expense totals into one workspace — the safe-spend number belongs in the same file.

## Free CLI preview

```bash
python3 jawadzelmadi_freelancer_toolkit.py --net-income income-sample.csv expenses-sample.csv
```
...
- [merge-ledger-guide.md](merge-ledger-guide.md) — goldenalien/206o platform CSV merge (run393)
...
Full bundle: [Ultimate Freelancer Toolkit landing](https://ytinumoc.github.io/toolkitlabs-invoice/jawadzelmadi-freelancer-toolkit/) — CSV templates, dashboard CLI, and all buyer-channel guides.
